...
You can find the exercise tasks in the file `saxpy_gpu.jl` or, alternatively, in notebook form as `saxpy_gpu.ipynb`. Remember, you need a NVIDIA GPU, so use the cluster and VS Code.
